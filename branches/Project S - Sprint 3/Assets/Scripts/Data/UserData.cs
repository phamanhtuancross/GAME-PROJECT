...
public static class DataKeys
{
    ...
    public const string DATA_KEY_DAY = "Day";
    public const string DATA_KEY_PERCENT_DAY = "PercentDay";
    public const string LEVEL_FAILED_COUNT = "FailedCount";
}
...
public static class UserData
{
    ...
    public static List<int> getCurrentQuest()
    {
        ...
        CurrentQuest = JsonUtility.FromJson<ListCurrentQuest>(PlayerPrefs.GetString(DataKeys.DATA_KEY_QUEST_COMPLETE,"{}")).quests;
    ...
    {
        int Day = PlayerPrefs.GetInt(DataKeys.DATA_KEY_DAY, 1);
        return Day;
    }
    public static int getPercentDay()
    {
        int PercentDay = PlayerPrefs.GetInt(DataKeys.DATA_KEY_PERCENT_DAY, 0);
        return PercentDay;
    }
    ...
    {
        ListCurrentQuest temp = new ListCurrentQuest();
        temp.quests = quests;
        PlayerPrefs.SetString(DataKeys.DATA_KEY_QUEST_COMPLETE, JsonUtility.ToJson(temp));
    }

    public static void setDay(int Day)
    {
        int lastDay = getDay();
        PlayerPrefs.SetInt(DataKeys.DATA_KEY_DAY, ++lastDay);
    }
    public static void setPercentDay(int percent)
    {
        PlayerPrefs.SetInt(DataKeys.DATA_KEY_PERCENT_DAY, percent);
    }
